...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _object_handlers_storage__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../object-handlers/storage */ \"./src/object-handlers/storage.js\");\n/* harmony import */ var _helper_functions_error__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../helper-functions/error */ \"./src/helper-functions/error.js\");\n/* harmony import */ var _helper_functions_dom__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../helper-functions/dom */ \"./src/helper-functions/dom.js\");\n/* harmony import */ var _helper_functions_reset__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../helper-functions/reset */ \"./src/helper-functions/reset.js\");\n/* harmony import */ var _object_handlers_task__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../object-handlers/task */ \"./src/object-handlers/task.js\");\n\n\n\n\n\n\nconst taskBox = (() => {\n  const show = (title) => {\n    const box = document.querySelector(\".task-box\");\n    const taskBoxTitle = document.querySelector(\".task-box-title\");\n    const taskButton = document.querySelector(\"#add-task-box\");\n\n    box.classList.remove(\"hidden\");\n    window.addEventListener(\"click\", (event) => {\n      if (event.target == box) hide();\n    });\n\n    if (title === \"New Task\") {\n      taskBoxTitle.textContent = title;\n      taskButton.textContent = \"Add Task\";\n    } else if (title === \"Update Task\") {\n      taskBoxTitle.textContent = title;\n      taskButton.textContent = \"Modify Task\";\n    }\n\n  };\n  const hide = () => {\n    const box = document.querySelector(\".task-box\");\n    box.classList.add(\"hidden\");\n  };\n  const addTask = () => {\n    const taskData = [];\n\n    const taskTitle = document.querySelector(\"#task-title\");\n    const taskDescription = document.querySelector(\"#task-description\");\n    const taskDueDate = document.querySelector(\"#task-date\");\n    const taskPriority = document.querySelector(\"#task-priority\");\n    const taskProject = document.querySelector(\"#task-projects\");\n    taskData.push(\n      taskTitle,\n      taskDescription,\n      taskDueDate,\n      taskPriority,\n      taskProject\n    );\n\n    if (taskData.every(_helper_functions_error__WEBPACK_IMPORTED_MODULE_1__.default)) {\n      // add to project\n      let newTask = _object_handlers_task__WEBPACK_IMPORTED_MODULE_4__.default.create(taskData);\n      let targetIndex = _object_handlers_storage__WEBPACK_IMPORTED_MODULE_0__.projects.findIndex(\n        (project) => project.title === taskProject.value\n      );\n      _object_handlers_storage__WEBPACK_IMPORTED_MODULE_0__.projects[targetIndex].list.push(newTask);\n      render(newTask);\n      _object_handlers_storage__WEBPACK_IMPORTED_MODULE_0__.storageController.store(\"projects\", _object_handlers_storage__WEBPACK_IMPORTED_MODULE_0__.projects);\n\n      // render on page (with evenHandlers)\n      taskData.forEach((element) => {\n        if (element.id === \"task-priority\" || element.id === \"task-projects\") {\n          element.selectedIndex = 0;\n        } else (0,_helper_functions_reset__WEBPACK_IMPORTED_MODULE_3__.default)(element);\n      });\n      hide();\n    }\n  };\n\n  const updateTask = () => {\n\n  }\n\n  const render = ({title, dueDate}) => {\n    const tasksContainer = document.querySelector(\".tasks\");\n    const referenceTask = document.querySelector(\"#add-task\");\n    const taskDiv = (0,_helper_functions_dom__WEBPACK_IMPORTED_MODULE_2__.default)(\"div\", \"task\");\n    tasksContainer.insertBefore(taskDiv, referenceTask);\n    \n    const leftPanel = (0,_helper_functions_dom__WEBPACK_IMPORTED_MODULE_2__.default)(\"div\", \"left-task-panel\");\n    taskDiv.appendChild(leftPanel);\n    const checkIcon = (0,_helper_functions_dom__WEBPACK_IMPORTED_MODULE_2__.default)(\"span\", \"far\", \"fa-circle\");\n    const titleSpan = (0,_helper_functions_dom__WEBPACK_IMPORTED_MODULE_2__.default)(\"span\");\n    titleSpan.textContent = title;\n    leftPanel.appendChild(checkIcon);\n    leftPanel.appendChild(titleSpan);\n    \n    const rightPanel = (0,_helper_functions_dom__WEBPACK_IMPORTED_MODULE_2__.default)(\"div\", \"right-task-panel\");\n    taskDiv.appendChild(rightPanel);\n    const dateSpan = (0,_helper_functions_dom__WEBPACK_IMPORTED_MODULE_2__.default)(\"span\");\n    dateSpan.textContent = dueDate;\n    const editIcon = (0,_helper_functions_dom__WEBPACK_IMPORTED_MODULE_2__.default)(\"span\", \"fas\", \"fa-edit\");\n    const trashIcon = (0,_helper_functions_dom__WEBPACK_IMPORTED_MODULE_2__.default)(\"span\", \"fas\", \"fa-trash\");\n    rightPanel.appendChild(dateSpan);\n    rightPanel.appendChild(editIcon);\n    rightPanel.appendChild(trashIcon);\n\n  };\n\n  const renderProject = (project) => {\n    project.forEach((task) => render(task));\n  };\n\n  return { show, hide, addTask, updateTask };\n})();\n\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (taskBox);\n\n\n//# sourceURL=webpack://todo-list/./src/dynamic-page/task-functionality.js?");
...
/***/ "./src/helper-functions/reset.js":
/*!***************************************!*\
  !*** ./src/helper-functions/reset.js ***!
  \***************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\nfunction resetValue(input) {\n  input.value = \"\";\n}\n\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (resetValue);\n\n//# sourceURL=webpack://todo-list/./src/helper-functions/reset.js?");
